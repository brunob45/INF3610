...
proc create_hier_cell_zed_hdmi_display { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.c_num_fstores {1} CONFIG.c_include_mm2s_dre {1} CONFIG.c_include_s2mm {0} CONFIG.c_mm2s_genlock_mode {0} CONFIG.c_mm2s_linebuffer_depth {4096}  ] $axi_vdma_0
  ...
  set_property -dict [ list CONFIG.C_S_AXIS_VIDEO_FORMAT {0} CONFIG.C_VTG_MASTER_SLAVE {1} CONFIG.C_HAS_ASYNC_CLK {1}  ] $v_axi4s_vid_out_0
