...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_getVal_fu_234", "Port" : "Y"}]},
		...
		"SubInstanceBlock" : [
			{"SubInstance" : "grp_getVal_fu_234", "SubBlockPort" : ["Y_blk_n_AR", "Y_blk_n_R"]}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_getVal_fu_234", "Parent" : "0",
		"CDFG" : "getVal",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
...
set ArgLastReadFirstWriteLatency {
	sobel_filter {
		...
		gmem2 {Type O LastRead 94 FirstWrite 2}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "165442899", "Max" : "165442899"}
	, {"Name" : "Interval", "Min" : "165442900", "Max" : "165442900"}
]}
