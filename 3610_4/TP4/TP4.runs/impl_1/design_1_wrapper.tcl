...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/TEMP/3610_4/TP4/TP4.cache/wt [current_project]
  set_property parent.project_path C:/TEMP/3610_4/TP4/TP4.xpr [current_project]
  set_property ip_repo_paths {
  c:/TEMP/3610_4/1798345_1798492/SobelLab4
  C:/TEMP/3610_4/1798345_1798492/ip_repo
} [current_project]
  set_property ip_output_repo C:/TEMP/3610_4/TP4/TP4.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet C:/TEMP/3610_4/TP4/TP4.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/TEMP/3610_4/TP4/TP4.srcs/sources_1/bd/design_1/design_1.bd
  set_property is_locked true [get_files C:/TEMP/3610_4/TP4/TP4.srcs/sources_1/bd/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc C:/TEMP/3610_4/1798345_1798492/ip_repo/AVNET_ZED_HDMI/constraints/zedboard_hdmi_display.xdc
  set_param project.isImplRun true
