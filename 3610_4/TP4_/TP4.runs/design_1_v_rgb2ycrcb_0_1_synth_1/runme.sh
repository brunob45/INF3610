...
HD_PWD='C:/TEMP/3610_4/TP4/TP4.runs/design_1_v_rgb2ycrcb_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_rgb2ycrcb_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_rgb2ycrcb_0_1.tcl
